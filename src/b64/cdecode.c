...
modified to use file/URL safe alphabet (base64url) as proposed in RFC 4648:
	character 62 (0x3E, '+') is replaced with a "-" (0x2D, dec 45, minus sign) (decoding array index 2)
	character 63 (0x3F) '/') is replaced with a "_" (0x5F, dec 95, underscore) (decoding array index 52)
*/
